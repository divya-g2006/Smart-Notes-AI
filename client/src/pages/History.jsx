...
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.6 }}
//         className="mb-10 rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 px-8 py-6 flex justify-between items-start md:items-center gap-4 flex-wrap shadow-[0_20px_45px_rgba(0,0,0,0.6)]"
//       >
...
//               bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900   /* ✅ DARK BLUE */
...
//               {/* ✅ ONLY THIS SECTION DARK BLUE */}
//               <div className='mb-4 space-y-1 bg-gradient-to-br from-blue-900 to-indigo-900 p-4 rounded-xl'>
